...
class OficinaType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('horaInicioAtencion', TimeType::class, ['required' => true, 'label' => 'Hora Inicio Atención'])
            ->add('horaFinAtencion', TimeType::class, ['required' => true, 'label' => 'Hora Fin Atención'])
