...
class OficinaTableType extends AbstractController implements DataTableTypeInterface
{
    ...
    public function configure(DataTable $dataTable, array $options)
    {
        ...
        $dataTable->add('localidad', TextColumn::class, ['label' => 'Localidad', 'searchable' => true,  'field' => 'o.localidad', 'orderField' => 'l.localidad, o.oficina', 'leftExpr' => "toUpper(l.localidad)", 'rightExpr' => function ($value) {
            return '%' . strtoupper($value) . '%';
        }]);
        ...
        $dataTable->add('habilitada', BoolColumn::class, ['label' => 'Habilitada', 'searchable' => true, 'className' => 'text-center', 'trueValue' => '<i class="fas fa-check"></i>', 'falseValue' => '<i class="fa fa-times"></i>', 'nullValue' => 'unknown']);
